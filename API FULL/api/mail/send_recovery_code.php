...
try {
    ...
    // Настройки письма
    $mail->isHTML(true);
    $mail->Subject = 'Код для восстановления пароля NILUrl';
    $mail->Body    = "Здравствуйте!<br><br>Ваш проверочный код для восстановления пароля: <b>$verificationCode</b><br><br>Спасибо!";
