...
try {
    ...
    $mail->setFrom('', 'NILUrl Разблокировка аккаунта'); 
    $mail->addAddress($email);

    // Настройки письма
    $mail->isHTML(true);
    $mail->Subject = 'Код для разблокировки аккаунта NILUrl';
    $mail->Body    = "Здравствуйте!<br><br>Ваш проверочный код для разблокировки аккаунта: <b>$verificationCode</b><br><br>Спасибо!";
