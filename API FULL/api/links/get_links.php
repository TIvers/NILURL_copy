...
$query = "
    SELECT l.base_url, l.code_url, l.date_last, l.tag, l.tag_svgcolor, l.tag_backgrounds, l.commentary, l.qr_open, l.utm, TO_CHAR(l.date_now, 'DD.MM.YYYY') as date_now, l.android, l.svgpath, l.ios, COALESCE(r.clicks, 0) as clicks
    FROM links l
    LEFT JOIN (
...
if ($result) {
    ...
    if (empty($links)) {
        ...
        foreach ($links as &$link) {
            $link['qr_open'] = $link['qr_open'] == 't' ? true : false;
