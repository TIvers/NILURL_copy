...
if (pg_num_rows($result) == 1) {
    ...
    if ($user['deletion_date'] !== null) {
        echo json_encode(array("success" => false, "recover" => true));
        ...
        $cookieDomain = "http://192.168.1.100:3000";
        setcookie("access_token", $access_token, time() + 3600, "/", $cookieDomain, true, true);
        setcookie("refresh_token", $refresh_token, time() + (7 * 24 * 60 * 60), "/", $cookieDomain, true, true);
