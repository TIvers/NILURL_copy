  ...
  const clickShowTags = () => {
    if (!ulShow) {
      if (refToUL.current != null) {
        ...
        setTimeout(() => {
          const ulHeight = refToUL.current.scrollHeight;
          if (ulHeight < 10) {
  ...
  return (
    <div className="TagsUIContainer">
      <div className="MainContainerTagsUI" onClick={clickShowTags}>
        ...
        <p className="period-button-text" >Тэг</p>
        <svg
          ref={refToStrelochka}
              ...
              >
                <div
                  style={{
                    ...
                    bottom: 0,
                    left: 0,
                    backgroundImage: `linear-gradient(to right, transparent, ${tag.backgrounds} 50%, transparent)`, 
