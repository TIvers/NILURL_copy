    ...
    <div>
      ...
      <div className="ContTOCEntr">
        <div className="FlexInIMPMP">
          ...
          >
            <g opacity="0.5" filter="url(#filter0_f_1_899)">
              <ellipse
                ...
                rx="350.224"
                ry="180.251"
                transform="rotate(-27.8851 594.862 309.121)"
            ...
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="196.1"
                  result="effect1_foregroundBlur_1_899"
                />
              </filter>
              <linearGradient
          ...
          >
            <BuyButton onClick={() => navigate(PRICEPAGE_ROUTE)}>
                Подробнее
              </BuyButton>
          </div>
          <img
            className="ThreeCardPicMP"
            src={process.env.PUBLIC_URL + "/TriCard.png"}
            alt="Привет"
          ></img>
        </div>
      </div>
