  ...
  useEffect(() => {
    fetch("https://nilurl.ru:8000/get_links.php", {
      ...
      .then(async (data) => {
        ...
        if (data.success === false && data.message === "not found") {
          setLoading(false);
...
//     try {
//         const response = await axios.get(`https://nilurl.ru:8000/fetch_favicon.php?url=${encodeURIComponent(url)}`);
        ...
        <div className="TopContainer">
          <div className="buttons-container">
            ...
            <div className="RightTopCont">
              ...
              />
              <CreateLinkNew availableLinks ={availableLinks} linkCount={linkCount} />
